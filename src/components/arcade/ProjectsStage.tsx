            ...
            >
              <div>
                <div className="flex items-center justify-between mb-1">
                  <span className={`font-silkscreen text-[10px] ${isSelected ? 'text-amber-400 font-bold' : 'text-slate-500'}`}>
                    MISSION 0{idx + 1}
                  </span>
                  <span className="text-[10px] font-mono-tech px-1.5 py-0.5 rounded bg-slate-900 text-slate-400 border border-slate-800">
                    {proj.category}
                  </span>
                </div>
                <div className={`font-chakra font-bold text-xs sm:text-sm line-clamp-2 ${
      ...
      <div className="arcade-panel p-6 sm:p-8 rounded-xl border-2 border-amber-500/40 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-amber-500/20 pb-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-amber-400 text-black font-silkscreen font-bold text-[10px] px-2 py-0.5 rounded">
                STAGE 02.{activeProjectIndex + 1}
              </span>
              <span className="font-mono-tech text-xs text-amber-400 uppercase tracking-widest">
                {activeProject.category}
              </span>
            </div>
            <h3 className="font-chakra text-2xl sm:text-4xl font-extrabold text-white tracking-wide glow-amber">
              {activeProject.title}
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-red-950/20 border border-red-500/30 p-4 rounded-lg">
            <div className="flex items-center gap-2 font-chakra font-bold text-red-400 text-sm mb-2 uppercase">
          ...
          <div className="bg-emerald-950/20 border border-emerald-500/30 p-4 rounded-lg">
            <div className="flex items-center gap-2 font-chakra font-bold text-emerald-400 text-sm mb-2 uppercase">
